    ...
    ?>
        <div class="pilule-entete entete-espace" style="position: relative;">
            ...
            <div>
                ...
                <img src="ressources/img/photo_profil.png" alt="Profil" class="icone-utilisateur" onclick="document.getElementById('popupUtilisateur').style.display = document.getElementById('popupUtilisateur').style.display === 'none' ? 'block' : 'none';">
                
                <div id="popupUtilisateur" style="display : none;">
